    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <nav className="bg-gradient-to-r from-gray-900 to-blue-900 text-white px-4 py-2 flex flex-wrap justify-between items-center">
        ...
        <img 
          src={Logo} 
          alt="Logo" 
          className="w-20 h-20 animate-spin-slow hover:scale-105 transition-transform duration-150" // Lasse das Logo ein wenig hovern
        />
      ...
      <motion.img 
        ...
        className="w-40 h-40 mb-8 hidden md:block" // Verstecke das Logo in der mobilen Ansicht
        initial="hidden"
        animate="visible"
