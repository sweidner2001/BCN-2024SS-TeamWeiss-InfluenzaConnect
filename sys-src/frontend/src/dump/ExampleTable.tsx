...
/**
 * @function ExampleInfluencerOverview Lediglich eine Beispieltabelle, um sich best. Layouts rauszukopieren
 * @author Sebastian Weidner
 * @since 14.06.2024
 * @version 1.0
 */
const ExampleInfluencerOverview: React.FC = () => {
...
export default ExampleInfluencerOverview;