...
In unserer Flask-Anwendung nutzen wir die mittgelieferte Session-Verwaltung der Flask-Bibliothek. Wenn sich ein Benutzer Anmeldet oder Registriert, wird seine E-Mail-Adresse in einer Session gespeichert. Diese Funktionalität gewährleistet, dass der Benutzer während seines Besuchs auf der Webseite identifiziert bleibt, was essenziell ist, um personalisierte Inhalte und Funktionen bereitzustellen. Die Flask-Bibliothek bietet uns ebenfalls die Möglichkeit, Session-Daten sicher zu verwalten. Zum Schutz sensibler Informationen wie der Benutzer-E-Mail verwenden wir Konfigurationsoptionen um die Datenübertragung zu verschlüsseln. Zusätzlich sorgt die eingstellte Sessionlaufzeit dafür, dass die Session nach 30 Minuten der Inaktivität automatisch abläuft und die Daten somit vor unautorisiertem Zugriff geschützt werden.
...
Diese Strukturierung und Automatisierung mittels Docker und GitHub Actions bietet eine
robuste Basis für den Betrieb und die Weiterentwicklung von "InfluenzaConnect".
